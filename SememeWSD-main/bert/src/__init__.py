...
from .bert_for_pre_training import BertNetworkWithLoss, BertPreTraining, \
    ...
    BertTrainOneStepWithLossScaleCellForAdam,BertNetworkForMask, \
    BertNetworkMatchBucket, BertPretrainEval,BertotherFormask
...
__all__ = [
    "BertNetworkForMask","BertotherFormask",
